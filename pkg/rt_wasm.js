...
export class Camera {
     ...
     */
    render(world) {
        _assertClass(world, HittableList);
        const ret = wasm.camera_render(this.__wbg_ptr, world.__wbg_ptr);
     ...
     */
    get aspect_ratio() {
        const ret = wasm.__wbg_get_camera_aspect_ratio(this.__wbg_ptr);
        return ret;
    }
    /**
     * @returns {number}
    ...
    set aspect_ratio(arg0) {
        wasm.__wbg_set_camera_aspect_ratio(this.__wbg_ptr, arg0);
    }
    /**
     * @param {number} arg0
     */
...
export class HittableList {
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(HittableList.prototype);
        obj.__wbg_ptr = ptr;
        HittableListFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        HittableListFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_hittablelist_free(ptr, 0);
    }
    /**
     * @param {number} x
     * @param {number} y
     ...
     */
    static new() {
        const ret = wasm.hittablelist_new();
        return HittableList.__wrap(ret);
    }
}
if (Symbol.dispose) HittableList.prototype[Symbol.dispose] = HittableList.prototype.free;
...
const HittableListFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('rt_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
